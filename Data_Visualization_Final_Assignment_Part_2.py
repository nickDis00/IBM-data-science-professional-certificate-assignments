...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            id='dropdown_statistics',  # Correct ID here
...
# Callback to update year dropdown based on statistics selection
@app.callback(
    Output(component_id='select-year', component_property='disabled'),
    Input(component_id='dropdown_statistics', component_property='value')  # Corrected ID here
)
...
# Callback for plotting graphs based on statistics and year selected
@app.callback(
    Output(component_id='output-container', component_property='children'),
    [Input(component_id='dropdown_statistics', component_property='value'), 
     Input(component_id='select-year', component_property='value')]  # Corrected ID here
)
